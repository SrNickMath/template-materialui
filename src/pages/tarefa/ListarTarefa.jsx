...
const ListarTarefa = () => {
  ...
  const handleDeletar = (id) => {
    ...
    <Card>
        ...
        <CardActions>
            <Button size="big" variant="contained" color="success" onClick={handleOpen}>Criar Tarefa</Button>
            <Button size="small" variant="outlined" color="warning" >Cancelar</Button>
      </CardActions> 
    </Card>
    <div>
      <Modal
